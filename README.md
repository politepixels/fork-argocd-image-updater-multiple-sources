####
#
# Reworked - multiple PRs combined to 0.12.2 + rework for multiple sources and .argocd-source-<appNAME>.yaml flow (as value file)
#
# + https://github.com/argoproj-labs/argocd-image-updater/pull/289
